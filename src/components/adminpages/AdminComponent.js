    ...
    render() {
        return (
            <AdminTemplate selectedIndex={0}>
                <DashBoard ebooks={this.props.ebooks} orders={this.props.orders} sales={this.props.sales}/>
            </AdminTemplate>
        );
    }
}

export const AdminDashboardPage = connect(mapStateToProps, mapDispatchToProps)(AdminComponent);
